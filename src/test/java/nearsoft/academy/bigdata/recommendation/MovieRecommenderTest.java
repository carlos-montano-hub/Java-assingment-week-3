...
public class MovieRecommenderTest {
    @Test
    public void testDataInfo() throws IOException, TasteException, InterruptedException {
        //download movies.txt.gz from 
        //http://snap.stanford.edu/data/web-Movies.html
        MovieRecommender recommender = new MovieRecommender("src/test/java/nearsoft/academy/bigdata/recommendation/movies.txt");
